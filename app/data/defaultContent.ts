...
import { HomeContent, PrinciplesContent, BusinessContent, PeopleContent, ContactContent, ServicesContent } from "../types/cms";

// This file serves as the "Hard Reset" source. 
// If the user wants to revert to the original text, we reload from here.
...
export const DEFAULT_CONTENT = {
        ...
        corePrinciples: [
            {
                ...
                description: "We prioritize the interests of our capital partners through clarity, transparency, and disciplined decision-making—treating every investment as a long-term responsibility, not a transaction."
            },
            {
                title: "Elevation of Performance",
                description: "We hold ourselves to institutional standards of execution, governance, reporting, and asset management—continually raising the bar across every project and platform."
            },
            {
                title: "Deliberate Specialization",
                description: "We believe real estate excellence is built through depth. Clear roles, domain expertise, and accountability across investment, development, and operations enable consistent outcomes."
            },
            {
                title: "Entrepreneurial Ownership",
                description: "We think like builders and operators, not intermediaries—bringing initiative, urgency, and long-term conviction to how assets are conceived, executed, and stewarded."
            },
            {
                title: "Creative Intelligence",
                description: "We apply cross-disciplinary thinking across finance, design, policy, and operations—challenging convention to unlock differentiated value in land and built environments."
            },
            {
                title: "Agility & Adaptation",
                description: "We anticipate shifts in markets, regulation, and demand—adapting strategy early to preserve resilience and capture emerging opportunity."
            },
            {
                title: "Collective Alignment",
                description: "We collaborate across partners, capabilities, and geographies—aligning incentives and execution to build platforms larger than any single asset or stakeholder."
            },
            {
                title: "Responsible Growth & Stewardship",
                description: "We integrate sustainability, environmental responsibility, and sound governance into how assets are underwritten, developed, and operated—enhancing resilience, accountability, and long-term value for all stakeholders."
            }
        ],
        section3: {
    ...
    contact: {
        ...
        formLine1End: "and I'm exploring a potential partnership or opportunity with ATit Capital.",
    ...
    services: {
        items: [
            {
                title: "Hotel Brand Management",
                description: "We build proprietary hospitality platforms anchored in real estate. Theme-led concepts, operator-grade systems, and owner-aligned structures enable scalable portfolios across urban and tourism markets."
            },
            {
                title: "Capital Solutions & Investment Vehicles",
                description: "We structure capital in fragmented markets. Pooled vehicles, JV and SPV architectures, and disciplined underwriting translate into scalable execution and institutional-quality reporting.",
                fullTitle: ""
            },
            {
                title: "Development & Execution Services",
                description: "We execute development with a focus on design quality, commercial viability, and long-term operational performance. From land acquisition and diligence to planning, approvals, construction management, leasing, and eventual stabilization or exit, we manage the full asset lifecycle."
            }
        ]
    }
};
